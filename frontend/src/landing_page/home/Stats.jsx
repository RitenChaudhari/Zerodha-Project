        ...
        <div className='container p-3'>
            <div className='row p-3'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.6+ crore customers trust Zerodha with ~
                    ...
                    <p className='text-muted'>No gimmicks, spam, "gamification", or annoying push notifications. 
                        ...
                        <span style={{ color: "#0046FF", cursor: "pointer", fontSize: "105%" }}>Our philosophies.</span> </p>
                    ...
                    <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do
                ...
                <div className='col-6 p-5'>
                    ...
                    <div className='text-center'>
                        <a href='' className='mx-5' style={{textDecoration:"none"}}>Explore our product <i className="fa fa-long-arrow-right"></i></a>
